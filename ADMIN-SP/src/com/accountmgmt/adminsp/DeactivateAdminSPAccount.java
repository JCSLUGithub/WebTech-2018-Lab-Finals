...
@WebServlet("/DeactivateAdminSPAccount")
public class DeactivateAdminSPAccount extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			accountMgmtDAO.deactivateAccount(accountMgmtDAO.connectToDB(), accountID);
