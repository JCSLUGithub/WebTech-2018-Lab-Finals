...
@WebServlet("/DeclineAdminSPAccount")
public class DeclineAdminSPAccount extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			accountMgmtDAO.declineAccount(accountMgmtDAO.connectToDB(), accountID);
